...
def upload_file_to_tos(
    ...
    client = None
    try:
        # DATABASE_TOS_ENDPOINT overrides the default Volcano Engine endpoint
        # (e.g. tos-ap-southeast-1.bytepluses.com for BytePlus).
        endpoint = os.getenv("DATABASE_TOS_ENDPOINT", f"tos-{region}.volces.com")
