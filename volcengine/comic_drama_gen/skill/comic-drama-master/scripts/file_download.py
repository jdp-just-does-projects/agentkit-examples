...
def file_download(
    ...
    """
    Download files to local storage in batch.

    Args:
        url: List of URLs
        save_dir: Save directory, default /tmp
        filename: List of filenames, corresponding one-to-one with the URLs
