...
class Status(BaseModel):
    ...
    message: str = Field(
        description="Empty if the run succeeded, otherwise the error message"
    )
...
class EvaluationResult(BaseModel):
    ...
    scores: float = Field(..., description="Overall score")


class EvaluationList(BaseModel):
    evaluation: EvaluationResult = Field(..., description="List of evaluation results")
