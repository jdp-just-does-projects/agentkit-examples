...
async def import_session(session_service, app_name, user_id, file_path):
    with open(file_path, "r", encoding="utf-8") as f:
        ...
        # Create a new session and copy the state
...
if __name__ == "__main__":
    prompt = (
        "Please generate a promotional video (product showcase video) for a "
        "Christmas limited dark chocolate gift box. "
        "Product image: http://lf3-static.bytednsdoc.com/obj/eden-cn/lm_sth/ljhwZthlaukjlkulzlp/ark/assistant/images/ad_chocolate.png "
        "Generate two first-frame images and two videos per shot."
    )
